...
public final class BrowserEditor extends TopComponent implements MultiViewElement
{
	...
	private Pane createBrowser()
	{
		...
		eng.load("http://www.nerduino.com/");
		...
		final TextField locationField = new TextField("http://www.nerduino.com/");

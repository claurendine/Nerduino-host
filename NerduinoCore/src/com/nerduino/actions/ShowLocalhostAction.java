...
@ActionID(
		category = "View",
		id = "com.nerduino.actions.ShowLocalhostAction")
@ActionRegistration(
		iconBase = "com/nerduino/resources/Skit16.png",
		displayName = "#CTL_ShowLocalhostAction")
@ActionReferences({})
@Messages("CTL_ShowLocalhostAction=Show Skits")
public final class ShowLocalhostAction implements ActionListener
{
	@Override
	public void actionPerformed(ActionEvent e)
	{
		...
		StartUpBrowserTopComponent.Current.setUrl("http://localhost:" + WebHost.Current.getPort()  + "/");
	}
}

...
@ActionID(
	category = "System",
	id = "com.nerduino.actions.UploadAction")
@ActionRegistration(
	surviveFocusChange = true,
	iconBase = "com/nerduino/resources/Upload16.png",
	displayName = "#CTL_UploadAction")
@ActionReferences(
{
})
@NbBundle.Messages("CTL_UploadAction=Nerduino")
				...
				public void run()
				{
					...
					if (node instanceof NerduinoBase)
					{
						...
						if (nerduino != null)
						{
							...
							boolean compiled = nerduino.compile();
							
							if (compiled)
							{
								StatusDisplayer.getDefault().setStatusText("Uploading to " + nerduino.getName() + " ...");
								
								nerduino.executeCommand("upload");
							}	

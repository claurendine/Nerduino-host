...
public class NerduinoTCPConfigDialog extends javax.swing.JDialog
{
	public NerduinoTcp m_nerduino;
	
	/** Creates new form SkitConfigDialog */
	public NerduinoTCPConfigDialog(java.awt.Frame parent, boolean modal)
	{
		super(parent, modal);
		initComponents();		
	}
    ...
    private void initComponents()
    {
        ...
        layout.setHorizontalGroup(
            ...
            .add(org.jdesktop.layout.GroupLayout.TRAILING, layout.createSequentialGroup()
                ...
                .add(jLabel5)
                .add(5, 5, 5)
                .add(txtIPAddress, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 286, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
                .add(45, 45, 45))
        );
...
private void btnOkMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnOkMouseClicked
	...
	if (m_nerduino != null)
	{
		...
		m_nerduino.setIPAddress(txtIPAddress.getText());
...
private void btnCancelMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnCancelMouseClicked
	...
	public void setNerduinoTCP(NerduinoTcp nerduino)
	{
		m_nerduino = nerduino;
		...
		if (m_nerduino != null)
		{
			try
			{
				...
				txtIPAddress.setText(m_nerduino.getIPAddress());
				...
				for(String name : portNames)
				{
					...
					for(Node node : NerduinoManager.Current.getChildren().getNodes())
					{
						if (node instanceof  NerduinoUSB)
						{
							...
							if (nu != m_FamilyXBee nu.getComPort().equals(name))
								found = true;
						}
					}
					*/

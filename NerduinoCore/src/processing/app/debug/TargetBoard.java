...
public class TargetBoard
{
	 ...
	 *
	 * @param menuId The menu ID
	 * @param selectionId The option ID
	 * @return
	 */
	...
	/**
	 * Returns the configuration parameters to override (as a PreferenceMap)
	 * when the specified option in the specified menu is selected
	 *
	 * @param menuId The menu ID
	 * @param selectionId The option ID
	 * @return

...
public class I18n
{
	...
	private static ResourceBundle i18n = ResourceBundle.getBundle("com.nerduino.resources.Resources");
	...
	static protected void init(String language)
	{
		...
		try
		{
			...
			i18n = ResourceBundle.getBundle("com.nerduino.resources.Resources", locale);
		}

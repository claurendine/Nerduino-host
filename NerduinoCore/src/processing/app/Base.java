...
//			 }
	...
	/**
	 * Store list of sketches that are currently open. Called when the
	 * application is quitting and documents are still open.
	 */
	/*
	...
	*/
	...
	/**
	 * Handle creating a sketch folder, return its base .pde file or null if the
...
*/
	...
	*/
	 ...
	 * @return the Editor object, so that properties (like 'untitled') can be
	 * set by the caller
	 * @throws Exception
	 */
	/*
...
*/
	// .................................................................
	/**
	 * Asynchronous version of menu rebuild to be used on save and rename to
	 * prevent the interface from locking up until the menus are done.
	 */
	/*
...
//		}
	...
	*/
	 ...
	 * should replace the sketch in the current window, or false when the sketch
...
//      }
	 ...
	 * may refer to the Contents subfolder of Processing.app, if we bundle
	 * things up as a single .app file with no additional folders.
	 */

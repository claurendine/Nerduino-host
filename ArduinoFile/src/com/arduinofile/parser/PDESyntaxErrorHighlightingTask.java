...
import com.arduinofile.jccparser.ParseException;
import com.arduinofile.jccparser.Token;
import com.arduinofile.parser.PDEParser.PDEParserResult;

public class PDESyntaxErrorHighlightingTask extends ParserResultTask
{
	@Override
	public void run(Result result, SchedulerEvent event)
	{
		try
		{
			PDEParserResult sjResult = (PDEParserResult) result;
